class Admin::ProgramsController < ApplicationController
  ...
  private
    ...
    def program_params
      params.require(:program).permit(:title, :description, :published, :backgroundcolor, :textcolor1, :textcolor2, :image, :backgroundimage, :remove_backgroundimage, :remove_image, :current)
    end
end